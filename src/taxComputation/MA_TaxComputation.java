...
public class MA_TaxComputation extends TaxComputationMethod {
    @Override
    ...
    boolean taxHoliday(Date date) {
        ...
        Date startDate = new GregorianCalendar(year, 8, 1).getTime();
        Date endDate = new GregorianCalendar(year, 8, 16).getTime();
